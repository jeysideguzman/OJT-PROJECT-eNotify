            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    if (!modelUser.getUid().equals(fuser.getUid())){
                        ...
                        if (modelUser.getName().toLowerCase().contains(query.toLowerCase()) || modelUser.getDepartment().toLowerCase().contains(query.toLowerCase()) ||
                                modelUser.getEmail().toLowerCase().contains(query.toLowerCase()) || modelUser.getCompany().toLowerCase().contains(query.toLowerCase())){
